...
public:
    ...
    void emitScreen(PascalParser::ScreenStatementContext *ctx);
    void emitShapes(PascalParser::ShapesStatementContext *ctx);
    void emitColor(PascalParser::ColorStatementContext *ctx);
    void emitFill(PascalParser::FillStatementContext *ctx);
    void emitGraphics(PascalParser::GraphicsStatementContext *ctx);
