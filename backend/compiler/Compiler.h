...
public:
    ...
    Object visitScreenStatement(PascalParser::ScreenStatementContext *ctx) override;
    Object visitGraphicsStatement(PascalParser::GraphicsStatementContext *ctx) override;
    Object visitShapesStatement(PascalParser::ShapesStatementContext *ctx) override;
    Object visitColorStatement(PascalParser::ColorStatementContext *ctx) override;

    Object visitFillStatement(PascalParser::FillStatementContext *ctx) override;
