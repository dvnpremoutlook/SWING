...
public:
    ...
    void emitInvokeSpecialValue(SymtabEntry *variableId);
    void emitNewValue(SymtabEntry *variableId);
    void emitSetScreenSize(SymtabEntry *variableId);
    void emitScreenLayout(SymtabEntry *variableId);
    void emitScreenVisible(SymtabEntry *variableId);
    void emitScreenLayoutWithGrid(SymtabEntry *variableId);
