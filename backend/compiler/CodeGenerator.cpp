...
void CodeGenerator::emitNewValue(SymtabEntry *variableId){
...
void CodeGenerator::emitInvokeSpecialValue(SymtabEntry *variableId){
    Typespec *type = variableId->getType()->baseType();
    Kind kind = variableId->getKind();
    int nestingLevel = variableId->getSymtab()->getNestingLevel();
    ...
    {
        string variableName = variableId->getName();
        string name = "javax/swing/JFrame/<init>()V";
        emit(INVOKESPECIAL,name);
    }
...
void CodeGenerator::emitSetScreenSize(SymtabEntry *variableId){
    Typespec *type = variableId->getType()->baseType();
    Kind kind = variableId->getKind();
    int nestingLevel = variableId->getSymtab()->getNestingLevel();
    ...
    {
        string variableName = variableId->getName();
        string name = "javax/swing/JFrame/setSize(II)V";
        emit(INVOKEVIRTUAL,name);
    }
...
void CodeGenerator::emitScreenLayout(SymtabEntry *variableId){
    Typespec *type = variableId->getType()->baseType();
    Kind kind = variableId->getKind();
    int nestingLevel = variableId->getSymtab()->getNestingLevel();
    ...
    {
        string variableName = variableId->getName();
        string name = "javax/swing/JFrame/setLayout(Ljava/awt/LayoutManager;)V";
        emit(INVOKEVIRTUAL,name);
    }
...
void CodeGenerator::emitScreenLayoutWithGrid(SymtabEntry *variableId){
    Typespec *type = variableId->getType()->baseType();
    Kind kind = variableId->getKind();
    int nestingLevel = variableId->getSymtab()->getNestingLevel();
...
void CodeGenerator::emitScreenVisible(SymtabEntry *variableId){
    Typespec *type = variableId->getType()->baseType();
    Kind kind = variableId->getKind();
    int nestingLevel = variableId->getSymtab()->getNestingLevel();
    ...
    {
        string variableName = variableId->getName();
        string name = "javax/swing/JFrame/setVisible(Z)V";
        emit(INVOKEVIRTUAL,name);
    }
