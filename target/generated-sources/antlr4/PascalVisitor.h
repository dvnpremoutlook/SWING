...
public:
   ...
   */
    ...
    virtual antlrcpp::Any visitScreenStatement(PascalParser::ScreenStatementContext *context) = 0;

    virtual antlrcpp::Any visitGraphicsStatement(PascalParser::GraphicsStatementContext *context) = 0;

    virtual antlrcpp::Any visitShapesStatement(PascalParser::ShapesStatementContext *context) = 0;

    virtual antlrcpp::Any visitColorStatement(PascalParser::ColorStatementContext *context) = 0;

    virtual antlrcpp::Any visitFillStatement(PascalParser::FillStatementContext *context) = 0;
