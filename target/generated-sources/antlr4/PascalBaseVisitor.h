...
public:
  ...
  virtual antlrcpp::Any visitScreenStatement(PascalParser::ScreenStatementContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitGraphicsStatement(PascalParser::GraphicsStatementContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitShapesStatement(PascalParser::ShapesStatementContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitColorStatement(PascalParser::ColorStatementContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitFillStatement(PascalParser::FillStatementContext *ctx) override {
    return visitChildren(ctx);
  }
