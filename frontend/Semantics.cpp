                                    ...
                                    PascalParser::RoutineDefinitionContext *ctx)
{
    ...
    routineId = symtabStack->enterLocal(
                    routineName, functionDefinition ? FUNCTION : PUBLIC);
    routineId = symtabStack->enterLocal(
                        routineName, functionDefinition ? FUNCTION : PRIVATE);
    routineId = symtabStack->enterLocal(
                            routineName, functionDefinition ? FUNCTION : ALLOWGRAPHICS);
...
Object Semantics::visitScreenStatement(PascalParser::ScreenStatementContext *ctx){
//	PascalParser::VariableContext *varCtx = ctx->variable();
//	visit(varCtx);
    PascalParser::VariableContext *varCtx = ctx->variable();
    visit(varCtx);
...
Object Semantics::visitFillStatement(PascalParser::FillStatementContext *ctx){
//	PascalParser::VariableContext *varCtx = ctx->variable();
//	visit(varCtx);
    PascalParser::VariableContext *varCtx = ctx->variable();
    visit(varCtx);
...
Object Semantics::visitColorStatement(PascalParser::ColorStatementContext *ctx){
//	PascalParser::VariableContext *varCtx = ctx->variable();
//	visit(varCtx);
    PascalParser::VariableContext *varCtx = ctx->variable();
    visit(varCtx);
...
//    }
    ...
    PascalParser::ExpressionContext *color = ctx->expression();
...
Object Semantics::visitShapesStatement(PascalParser::ShapesStatementContext *ctx){
//	PascalParser::VariableContext *varCtx = ctx->variable();
//	visit(varCtx);
    PascalParser::VariableContext *varCtx = ctx->variable();
    visit(varCtx);
    PascalParser::FactorContext *facCtx = ctx->factor();
    visit(facCtx);
//    string controlName = toLowerCase(varCtx->variableIdentifier()->getText());
//    Typespec *controlType = Predefined:: integerType;
//
...
//    }
    ...
    PascalParser::ExpressionContext *posx = ctx->expression()[0];
    PascalParser::ExpressionContext *posy   = ctx->expression()[1];
    PascalParser::ExpressionContext *width   = ctx->expression()[2];
...
Object Semantics::visitGraphicsStatement(PascalParser::GraphicsStatementContext *ctx){
//	PascalParser::VariableContext *varCtx = ctx->variable();
//	visit(varCtx);
    PascalParser::VariableContext *varCtx = ctx->variable();
    visit(varCtx);
