...
enum class Kind
{
    ...
    PROGRAM, PROCEDURE, FUNCTION,PRIVATE,ALLOWGRAPHICS,PUBLIC,
    UNDEFINED
};
...
constexpr Kind ALLOWGRAPHICS            = Kind::ALLOWGRAPHICS;
constexpr Kind PUBLIC            = Kind::PUBLIC;
constexpr Kind PRIVATE            = Kind::PRIVATE;
