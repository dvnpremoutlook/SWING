...
program           : (PLAIN | SWING) programHeader block '.' ;
programHeader     : (PROGRAM | PROGRAMS) programIdentifier programParameters? ';' ; 
...
procedureHead     : ( PUBLIC | PRIVATE | ALLOWGRAPHICS) routineIdentifier parameters? ;
...
screenStatement : SCREEN  variable SIZEX expression SIZEY expression (CREATE | ADDGRAPHICS) ;
graphicsStatement : GRAPHICS variable PAINTING ;
shapesStatement : SHAPE  variable POSITIONX factor POSITIONY expression WIDTH expression HEIGHT expression (RECTANGLE | CIRCLE) ;
colorStatement : COLOR variable SET expression ;
fillStatement : FILL variable WINDOW;
...
ALLOWGRAPHICS : A L L O W G R A P H I C S ;
PAINTING     : P A I N T I N G; 
ADDGRAPHICS  : A D D G R A P H I C S ;
SHAPE      : S H A P E ; 
POSITIONX  : P O S I T I O N X ;
POSITIONY  : P O S I T I O N Y ;
WIDTH      : W I D T H ;
HEIGHT     : H E I G H T ;
